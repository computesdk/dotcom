...
If you want to use another sandbox provider like E2B or Daytona, all you need to do is change your provider variable from `HOPX_API_KEY=xxxxx` to `E2B_API_KEY=xxxxx`. ComputeSDK automatically detects your sandbox provider from your environment variables.
...
// Custom vite.config.js to allow access to sandbox at port 5173
  ...
  export default defineConfig({
    ...
    server: {
      ...
      strictPort: true,
      hmr: false,
      allowedHosts: ['.hopx.ai', 'localhost', '127.0.0.1', '.computesdk.com'],
    },
  })
  `;
