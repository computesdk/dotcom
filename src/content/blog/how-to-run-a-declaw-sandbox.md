---
title: "How to run a Declaw sandbox"
description: "A step-by-step process for creating a sandbox with Declaw, running a basic Vite app inside, and accessing it securely via the browser."
date: "2026-07-13"
tags: [how-to, sandboxes, declaw]
author: "David Tice"
...
<span style="font-size: 14px; font-style: italic;">You can clone <a href="https://github.com/computesdk/examples/tree/main/declaw-basic" target="_blank">this repo</a> and update your credentials to run locally.</span>

Declaw runs Firecracker microVMs with a built-in security stack: PII scanning, prompt-injection defense, a TLS-intercepting egress proxy, and per-sandbox network policies.
Let's walk through the process of getting a basic application running inside a Declaw sandbox.
...
```bash
npx create-next-app@latest declaw-basic
```
...
### Install ComputeSDK and the Declaw provider
...
## Create or log in to your Declaw account
<!-- markdownlint-disable-next-line MD033 -->
Create a Declaw account or log in <a href="https://declaw.ai" target="_blank">here</a>.\
...
Declaw resolves this through its own sandbox domain. We don't have a fixed domain to pin down here — add it to the `allowedHosts` array above once you see it in your terminal output.
...
1. See a new sandbox created in your Declaw dashboard.
2. See a preview URL logged to your terminal output.
3. Finally, if you visit that URL you should see the boilerplate Vite React app running in your Declaw sandbox!

<!-- markdownlint-disable-next-line MD033 -->
<img style="margin: 12px auto; border-radius: 10px;" width="700px" src="/sandbox-vite-app-in-browser.png" alt="screenshot of Vite app running in Declaw sandbox via ComputeSDK" title="Basic Vite App in Declaw sandbox" />
