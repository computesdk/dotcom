...
Upstash resolves this through its own Default Box preview domain (Ephemeral Boxes don't support preview URLs at all). We don't have a fixed domain to pin down here — add it to the `allowedHosts` array above once you see it in your terminal output.
